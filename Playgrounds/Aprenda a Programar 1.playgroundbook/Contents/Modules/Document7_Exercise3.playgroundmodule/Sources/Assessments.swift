...
public func assessmentPoint() -> AssessmentResults {
    ...
    var hints = [
            NSLocalizedString("Even though this puzzle looks different from others you’ve seen, you can still solve it using the right-hand rule. Always follow the right wall of the maze, and you’ll eventually reach the gem.", comment:"Hint"),
