...
class LTC1_C01P01_Scene: SceneViewController {
    ...
    override func viewDidLoad() {
        ...
        // Because "Learn to Code 1" and "Hello, Byte" share the same source,
        ...
        // "Learn to Code 1" and "Hello, Byte" have their own storyboards for chapter 1,
        ...
        let _ = NSLocalizedString("Hello, Byte", comment: "heading text: title of this playground")
