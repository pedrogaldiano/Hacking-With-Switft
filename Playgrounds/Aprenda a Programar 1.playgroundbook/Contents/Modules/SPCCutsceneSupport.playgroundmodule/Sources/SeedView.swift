...
public class SeedView: UIView {
    ...
    public override func animateToFullSizeWithPop(duration: TimeInterval, delay: TimeInterval) {

        // Animate the size of the image view. Leave the parent view as it is.
        self.imageView?.animateToFullSizeWithPop(duration: duration, delay: delay)
    }
