...
public func assessmentPoint() -> AssessmentResults {
    ...
    case 0..<5:
        break
    case 5...7:
        hints[0] = NSLocalizedString("You’re doing great! Some of the best coders in the world try and fail often. Every time you correct a mistake, your brain gets a little better at what you’re doing, even if it doesn’t feel that way!", comment:"Hint")
    default:
        break
