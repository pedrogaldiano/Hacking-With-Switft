...
Be careful. If the value of `index` is greater than the number of items in the `heights` array, you’ll try to access a value that doesn’t exist. This will give you an [index out of range error](glossary://index%20out%20of%20range%20error). You can prevent this by making sure your `index` value is never greater than `heights.count`, the number of items in your array.
...
//#-localizable-zone(ch13ex08k1)
        // Place a block.
//#-end-localizable-zone
        
    }
//#-localizable-zone(ch13ex08k2)
    // Increment the index.
//#-end-localizable-zone
