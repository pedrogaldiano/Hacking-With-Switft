...
First, you’ll need to create an instance of [type](glossary://type) `Portal` and pass in a color. Next, you’ll place the portal by specifying coordinates for both the starting side of the portal and the ending side. An example is shown below.
...
//#-code-completion(identifier, show, isOnOpenSwitch, if, func, for, while, moveForward(), turnLeft(), turnRight(), collectGem(), toggleSwitch(), north, south, east, west, Expert, Character, Portal, color:, (color:), Block, (, ), (), turnLockUp(), turnLockDown(), isOnClosedSwitch, var, let, ., =, <, >, ==, !=, +=, +, -, isBlocked, isOnGem, move(distance:), jump(), true, false, turnLock(up:numberOfTimes:), world, place(_:facing:atColumn:row:), place(_:atColumn:row:), place(_:atStartColumn:startRow:atEndColumn:endRow:), isBlockedLeft, &&, ||, !, isActive, isBlockedRight)
//#-editable-code
