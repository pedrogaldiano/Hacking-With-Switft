...
NSLocalizedString("After you add coordinates to your array, [iterate](glossary://iteration) over each coordinate in the array, placing five blocks at each coordinate. You may want to write an additional [`for` loop](glossary://for%20loop) inside your `for-in` loop:\n\n```swift\nfor coordinate in blockLocations {\n    for i in 1...5 {\n        // place a block\n    }\n}\n", comment:"Hint")
]
