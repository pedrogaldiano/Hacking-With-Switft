...
let hints = [
    NSLocalizedString("Before you can place a block, you need to create an [instance](glossary://instance) of the `Block` [type](glossary://type). Use the following code: `let block1 = Block()`.", comment:"Hint"),
