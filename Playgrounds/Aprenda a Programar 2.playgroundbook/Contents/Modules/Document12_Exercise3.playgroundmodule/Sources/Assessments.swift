...
let success = NSLocalizedString("### You’re getting quite good at this! \nNow that you’ve experimented with placing blocks, portals, switches, and stairs, you know the fundamentals for building worlds. Next, it’s time to give some of those skills a try in solving some advanced world-building puzzles. \n\n[**Next Page**](@next)", comment:"Success message")
let hints = [
    NSLocalizedString("You can use the following code to create an [instance](glossary://instance) of type `Stair` and place it at the same time: `world.place(Stair(), facing: east, atColumn: 3, row: 3)`.", comment:"Hint"),
    NSLocalizedString("Place stairs in the puzzle world so that you can guide your character to toggle all the switches open. You can take any of several different approaches.", comment:"Hint")
]
