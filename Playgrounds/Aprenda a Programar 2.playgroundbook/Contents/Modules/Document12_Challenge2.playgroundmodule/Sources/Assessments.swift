...
let hints = [
    ...
    NSLocalizedString("You need to [initialize](glossary://initialization) an [instance](glossary://instance) of your character or the expert to solve this puzzle. In case you’ve forgotten, [here’s a refresher](Document11.playgroundchapter/Exercise3.playgroundpage).", comment:"Hint"),
