...
let hints = [
    ...
    NSLocalizedString("To insert an instance of type `Expert` into the array, call `insert(element: Element, at: Int)` on the `characters` array: `insert(Expert(), at: 2)`.", comment:"Hint")
]
